    ...
    <body class="d-flex flex-column min-vh-100">
        ...
        <div class="header-container py-3 border-bottom" style="background-color: black; color: white;">
            <div class="row align-items-center">
                ...
                <!-- Right Section (Account, Cart, Order) -->
                <div class="col-md-4 d-flex justify-content-end align-items-center">
                    <div style="padding-right: 20px;">
                        ...
                        <c:if test="${account != null}">
                            ...
                            <a href="<c:url value='/account/logout.do'/>" class="btn btn-outline-light">Logout</a> |
                        </c:if>
                        ...
                        <c:if test="${not empty account}">
                            | <a href="<c:url value='/order/index.do?id=${account.id}'/>" class="btn btn-outline-light">
                                Orders <i class="bi bi-box-seam"></i>
        ...
        <!-- Main Content -->
        <div class="container flex-grow-1 d-flex flex-column"> <!-- Allows main content to push footer down -->
